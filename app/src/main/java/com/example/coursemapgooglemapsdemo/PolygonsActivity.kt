...
import com.example.coursemapgooglemapsdemo.databinding.ActivityPolygonsBinding
...
class PolygonsActivity : AppCompatActivity(), OnMapReadyCallback {
    ...
    private lateinit var binding: ActivityPolygonsBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityPolygonsBinding.inflate(layoutInflater)
